...
analysis_name = "run_20210914_test"
...
fp_csv_model_input_ranges = os.path.join(dir_cur, "class_3_model_input_ranges.csv")
fp_csv_out_lhs_trials = os.path.join(dir_ed, f"class_3_lhs_trials_{analysis_name}.csv")
